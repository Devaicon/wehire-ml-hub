...
output_keys = {
    ...
    "aboutMe": {"about": "string"},
    "professionalSkills": {"skills": ["string", "string", "..."]},
    "workExpereince": [
        {
            "jobTitle": "string",
            "companyName": "string",
    ...
    "links": {
        "socialMedias": [
            {"title": "string (platform name)", "link": "string (valid URL)"}
        ]
    },
    "language": {
        "languages": [
    ...
    "preferredJobBenefits": [{"benefits": ["string", "..."]}],
    "jobAchievements": [{"achievements": ["string", "..."]}],
    "filters": {"gender": "", "education_level": "", "job_type": "", "work_mode": ""},
}
